...
public class MaxDurationAnalysisTest {
  ...
  private final MaxDurationAnalysis analysis = new MaxDurationAnalysis();
  ...
  @Test
  public void twoSessions_returnsLonger() {
    ...
    assertEquals(120L, (long) (Long) analysis.apply(sessions).getValue());
  }
}
